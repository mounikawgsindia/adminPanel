...
class FlashSaleRejectAdapter(val viewModel: FlashSaleViewModel, val context: Context, var list:ArrayList<RejectedFlashSale>):
    RecyclerView.Adapter<FlashSaleRejectAdapter.ViewHolder> (){
    ...
    fun setData(newData:ArrayList<RejectedFlashSale>){
        list=newData
