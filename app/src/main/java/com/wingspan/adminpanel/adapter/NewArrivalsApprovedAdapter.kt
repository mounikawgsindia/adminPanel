...
class NewArrivalsApprovedAdapter(val viewModel: NewArrivalsViewModel, val context: Context, var list:ArrayList<ApprovedNewArrivals>):
    RecyclerView.Adapter<NewArrivalsApprovedAdapter.ViewHolder> () {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            Glide.with(context)
                ...
                .diskCacheStrategy(DiskCacheStrategy.ALL).placeholder(R.drawable.defaultfood_image)
                .error(
                    R.drawable.defaultfood_image
                ).into(image)
    ...
    fun setData(newData: ArrayList<ApprovedNewArrivals>) {
        list = newData
